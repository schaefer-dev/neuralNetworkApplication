...
\begin{enumerate}[a)]
    \item 
        % TODO
        TODO explain the shifting of values here:\\\\
    ...
    \item
        % TODO
        TODO: State where we might still might encounter problems and give an example which makes softmax useless even when using the pro- posed scheme.
\end{enumerate}
