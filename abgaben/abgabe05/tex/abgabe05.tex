...
\begin{enumerate}[a)]
    \item   
        see code \verb!nn.py! and also \verb!nn_withoutTF.py!
    \item
        see code, unfortunatly this functions contains an error we were not able to fix in time, which causes our training to not ''occur''/''progress'' (see README.txt)
    \item
        Plot output:\\
        \begin{center}
